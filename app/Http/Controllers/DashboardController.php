...
class DashboardController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $transaksiBulanIni = (clone $query)

            ->whereYear('periode', $tahunSekarang)

            ->whereMonth('periode', $bulanSekarang)
        ...
        $transaksiBulanLalu = (clone $query)

            ->whereYear('periode', $tahunSekarang)

            ->whereMonth('periode', $bulanSekarang - 1)
        ...
        if ($transaksiBulanLalu > 0) {
            ...
            $growth = (($transaksiBulanIni - $transaksiBulanLalu) / $transaksiBulanLalu) * 100;
